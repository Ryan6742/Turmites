...
#Implementation of Turmite undocumented. I have no idea how it works, 
#and I remember also having no idea how I got it to work. I was just
#messing around with parameters until it stopped bugging out on me
#and then, once it started working, it did more than I could imagine.
#That being said, it doesn't do much, and it is probably possible 
#to figure out how this works. Also, I wonder what it would be like
#if I got rid of the Game of Life part of it.
class Turmite():
    def __init__(self):
        self.alive = True
        self.energy = 50
